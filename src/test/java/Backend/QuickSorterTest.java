...
public class QuickSorterTest
{
    ...
    public void init()
    {
        ...
        r1 = new Release("name", "1", ">", 0);
        r2 = new Release("name", "1", ">", 0);
        r3 = new Release("name", "1", ">", 0);
        r4 = new Release("name", "1", ">", 0);
        r5 = new Release("name", "1", ">", 0);
        r6 = new Release("name", "1", ">", 0);
        r7 = new Release("name", "1", ">", 0);
        r8 = new Release("name", "1", ">", 0);
        r9 = new Release("name", "1", ">", 0);
        r10 = new Release("name", "1", ">", 0);
